...
public class Command {
    ...
    //randomPuzzle command
    public Command(CommandWord command, int size, int fill, int row, int column) {
        super();
    ...
    public String toString() {
        if (command == CommandWord.RANDOM || command == CommandWord.NEW) {
            return "Command " + command + ", row=" + size + ", column="
                    + size;
        }
